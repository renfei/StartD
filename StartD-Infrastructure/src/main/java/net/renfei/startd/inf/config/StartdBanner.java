package net.renfei.startd.inf.config;
 ...
 * @author renfei
 */
public class StartdBanner implements Banner {
    ...
    public void printBanner(Environment environment, Class<?> sourceClass, PrintStream printStream) {
        ...
        String version = SpringBootVersion.getVersion(), url = "== https://startd.renfei.net ==";
